...
public class DatabaseMethodsClass {
    ...
    public static void updateFirstName(String email) {
        ...
        try {
            ...
            String sql = "update users set first_name= '"+firstName+"' where id ='"+email+"'";
    ...
    public static void updateLastName(String email) {
        ...
        try {
            ...
            String sql = "update users set last_name = '"+lastName+"' where id ='"+email+"'";
    ...
    public static void updateEmail(String email) {
        ...
        try {
            ...
            String sql = "update users set email = '"+mail+"' where id ='"+email+"'";
    ...
    public static void updatePassword(String email) {
        ...
        try {
            ...
            String sql = "update users set password = '"+password+"' where id ='"+email+"'";
    ...
    public static void updateAddress(String email) {
        ...
        try {
            ...
            String sql = "update users set address= '"+address+"' where id ='"+email+"'";
    ...
    public static void updatePostalCode(String email) {
        ...
        try {
            ...
            String sql = "update users set postal_code= '"+postalCode+"' where id ='"+email+"'";
    ...
    public static void updateCity(String email) {
        ...
        try {
            ...
            String sql = "update users set city= '"+city+"' where id ='"+email+"'";
    ...
    public static void updateCountry(String email) {
        ...
        try {
            ...
            String sql = "update users set country= '"+country+"' where id ='"+email+"'";
